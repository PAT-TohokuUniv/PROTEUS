...
contains
  ...
  subroutine v__in__ini(spl, set) ! out
    ...
    ! directory setting
    set%dir_name = './Venus/Krasnopolsky_2013'
  ...
  subroutine v__in__exe(cst,      & ! in
    ...
    ! species
    ! 
    ! SO3, H2O, H2SO4, CO, CO2, SO2, OCS, (SO)2, S2, SO, S, S3, M, NO, SNO, SH, H2S, H, H2, HCl, Cl, ClSO2, SO2Cl2, Cl2, SCl, HSCl, OH, S4
    ! 
    spl%species(1) = 'SO3'
    spl%species(2) = 'H2O'
    spl%species(3) = 'H2SO4'
    ...
    spl%label_fix(28) = 0 ! S4: variable
    ...
    spl%all_to_var(7) = 6 ! OCS: variable
    spl%all_to_var(8) = 7 ! (SO)2: variable
    spl%all_to_var(9) = 8 ! S2: variable
    spl%all_to_var(10) = 9 ! SO: variable
    spl%all_to_var(11) = 10 ! S: variable
    spl%all_to_var(12) = 11 ! S3: variable
    spl%all_to_var(15) = 12 ! SNO: variable
    spl%all_to_var(16) = 13 ! SH: variable
    spl%all_to_var(17) = 14 ! H2S: variable
    spl%all_to_var(18) = 15 ! H: variable
    spl%all_to_var(19) = 16 ! H2: variable
    spl%all_to_var(21) = 17 ! Cl: variable
    spl%all_to_var(22) = 18 ! ClSO2: variable
    spl%all_to_var(23) = 19 ! SO2Cl2: variable
    spl%all_to_var(24) = 20 ! Cl2: variable
    spl%all_to_var(25) = 21 ! SCl: variable
    spl%all_to_var(26) = 22 ! HSCl: variable
    spl%all_to_var(27) = 23 ! OH: variable
    spl%all_to_var(28) = 24 ! S4: variable
    ...
    spl%var_to_all(6) = 7 ! OCS: variable
    spl%var_to_all(7) = 8 ! (SO)2: variable
    spl%var_to_all(8) = 9 ! S2: variable
    spl%var_to_all(9) = 10 ! SO: variable
    spl%var_to_all(10) = 11 ! S: variable
    spl%var_to_all(11) = 12 ! S3: variable
    spl%var_to_all(12) = 15 ! SNO: variable
    spl%var_to_all(13) = 16 ! SH: variable
    spl%var_to_all(14) = 17 ! H2S: variable
    spl%var_to_all(15) = 18 ! H: variable
    spl%var_to_all(16) = 19 ! H2: variable
    spl%var_to_all(17) = 21 ! Cl: variable
    spl%var_to_all(18) = 22 ! ClSO2: variable
    spl%var_to_all(19) = 23 ! SO2Cl2: variable
    spl%var_to_all(20) = 24 ! Cl2: variable
    spl%var_to_all(21) = 25 ! SCl: variable
    spl%var_to_all(22) = 26 ! HSCl: variable
    spl%var_to_all(23) = 27 ! OH: variable
    spl%var_to_all(24) = 28 ! S4: variable
    ...
    var%m(28) = 128.00000000_dp * cst%m_u !S4
    ...
    var%q(28) = 0.0_dp * cst%q_e !S4

    ! read P, L, J list
    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/Production_list.dat', status = 'unknown' )
      do isp = 1, spl%nsp_i
        read(11,*) (spl%Prod_list(isp,ich), ich = 1, spl%nch_P)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/Loss_list.dat', status = 'unknown' )
      do isp = 1, spl%nsp_i
        read(11,*) (spl%Loss_list(isp,ich), ich = 1, spl%nch_L)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/Jacobian_list.dat', status = 'unknown' )
      do i = 1, spl%n_Jlist
        read(11,*) (spl%Jmtx_list(i,j), j = 1, spl%nch_J)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/reactant_list.dat', status = 'unknown' )
      do ich = 1, spl%nch
        read(11,*) (spl%reactant_list(ich,isp), isp = 1, 10)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/product_list.dat', status = 'unknown' )
      do ich = 1, spl%nch
        read(11,*) (spl%product_list(ich,isp), isp = 1, 10)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/reaction_type_list.dat', status = 'unknown' )
      do ich = 1, spl%nch
        read(11,*) spl%reaction_type_list(ich)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/rate_rpn_token.dat', status = 'unknown' )
      do ich = 1, spl%nch
        do i = 1, 3
    ...
    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/rate_rpn_label.dat', status = 'unknown' )
      do ich = 1, spl%nch
        do i = 1, 3
    ...
    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/rate_cases.dat', status = 'unknown' )
      read(11,*) (spl%rate_cases(ich), ich = 1, spl%nch)
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/PLJ_list/T_range.dat', status = 'unknown' )
      do ich = 1, spl%nch
        do i = 1, 3
    ...
    open(11, file = './Venus/Krasnopolsky_2013/input/Temperature/T_e.dat', status = 'unknown' )
      do iz = 1, grd%nz
        read(11,*) tmp,var%Te(iz)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/Temperature/T_i.dat', status = 'unknown' )
      do iz = 1, grd%nz
        read(11,*) tmp,var%Ti(iz)
      end do
    close(11)

    open(11, file = './Venus/Krasnopolsky_2013/input/Temperature/T_n.dat', status = 'unknown' )
      do iz = 1, grd%nz
    ...
    if (isp >= 1 .and. isp <= spl%nsp) then
      open(11, file = './Venus/Krasnopolsky_2013/input/density/H2O.dat', status = 'unknown' )
        do iz = 1, grd%nz
    ...
    if (isp >= 1 .and. isp <= spl%nsp) then
      open(11, file = './Venus/Krasnopolsky_2013/input/density/CO2.dat', status = 'unknown' )
        do iz = 1, grd%nz
          read(11,*) tmp, var%ni(isp,iz)
        end do
      close(11)
    ...
    if (isp >= 1 .and. isp <= spl%nsp) then
      open(11, file = './Venus/Krasnopolsky_2013/input/density/SO2.dat', status = 'unknown' )
        do iz = 1, grd%nz
          read(11,*) tmp, var%ni(isp,iz)
        end do
      close(11)
    ...
    isp = sp_index(spl, 'NO')
    if (isp >= 1 .and. isp <= spl%nsp) then
      open(11, file = './Venus/Krasnopolsky_2013/input/density/NO.dat', status = 'unknown' )
        do iz = 1, grd%nz
          read(11,*) tmp, var%ni(isp,iz)
        end do
      close(11)
    ...
    if (isp >= 1 .and. isp <= spl%nsp) then
      open(11, file = './Venus/Krasnopolsky_2013/input/density/HCl.dat', status = 'unknown' )
        do iz = 1, grd%nz
          read(11,*) tmp, var%ni(isp,iz)
        end do
      close(11)
    ...
    var%UpperBC(isp,1) = 3.0_dp
    var%UpperBC(isp,2) = 6.0e-6_dp

    isp = sp_index(spl, 'H2S')
    var%UpperBC(isp,1) = 3.0_dp
    var%UpperBC(isp,2) = 6.0e-6_dp

    isp = sp_index(spl, 'H2SO4')
    var%UpperBC(isp,1) = 2.0_dp
    var%UpperBC(isp,2) = -5.7e15_dp
