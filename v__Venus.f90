...
module v__Venus
  ...
  private
  public :: v__Venus__ini, v__Venus__exe
...
contains
  ...
  !
  !----------------------------------------------------------------------------------------------------------
  subroutine v__Venus__ini(spl, & ! in
    &                      set  ) ! inout
  ...
  end subroutine v__Venus__ini



  !----------------------------------------------------------------------------------------------------------
  !
  !                                           Special treatment for Venus
  !
  !----------------------------------------------------------------------------------------------------------
  subroutine v__Venus__exe(spl, cst, grd, flx, & ! in
    &                      var                 ) ! inout
    type(spl_),   intent(in)     :: spl
